...
- Chain Insights proxy `tools/list` exposes local `balance`, `help`, `address_risk`, `trace_victim_funds`, `trace_suspect_funds`, and `trace_deposit_sources`, plus public proxied GraphRAG tools.
