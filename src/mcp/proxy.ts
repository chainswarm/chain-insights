...
const CHAIN_INSIGHTS_WORKFLOW = [
  ...
  '6. For local review, use live vault notes refreshed with cia case vault refresh. When a case reaches a sharing or archive checkpoint, use case_verify_evidence and case_export to produce Obsidian, LLMWiki, Codex, Claude Code, and ChatGPT-ready handoff bundles.',
].join('\n')
...
export async function createProxy(): Promise<void> {
  ...
  server.registerTool(
    'case_export',
    {
      description: 'Export a Chain Insights case to an Obsidian, LLMWiki, Codex, Claude Code, and ChatGPT-friendly handoff bundle.',
      inputSchema: {
      ...
      content: [
        {
          ...
          text: [
            ...
            '- case_export: export a case for Obsidian, LLMWiki, Codex, Claude Code, and ChatGPT handoff bundles.',
