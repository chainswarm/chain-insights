...
const GRAPH_SCHEMA_HINTS = [
  ...
  '- Facts graph labels include Address and AddressFeature; the TRANSFER relationship connects two Address nodes. Neuron identity, hotkey/coldkey pairing, and IP/axon-port observation live on the topology Neuron node, not on facts. Facts address keys match topology address values exactly.',
