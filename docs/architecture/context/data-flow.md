...
- **Chain Insights Graph MCP endpoint:** Topology queries (live_topology, archive_topology), fact queries (labels, features, risk scores), network capabilities, usage status
