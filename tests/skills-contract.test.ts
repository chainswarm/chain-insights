...
describe('shipped Chain Insights skills contract', () => {
  it('keeps investigation guidance on initialized workspaces and role-specific trace tools', () => {
    ...
    expect(skill).toContain('LINKED` overlay is served on both the topology and facts graphs')
  ...
  it('documents facts-tier LINKED ownership-overlay projection wherever schema probes are shipped (LINKED served on both topology and facts)', () => {
    const readme = read('README.md')
