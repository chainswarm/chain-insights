...
const KNOWN_PUBLIC_TOOL_ALLOWED_ARGS = {
	aml_address_risk: [
		"address",
		"network",
		"compare_address",
...
function normalizeRemoteToolArguments(toolName, args) {
	...
	const allowedArgs = KNOWN_PUBLIC_TOOL_ALLOWED_ARGS[toolName];
...
function registerLocalPrompts(server) {
	...
	server.registerPrompt("aml-trace-suspect-funds", {
		...
		argsSchema: { suspect_addresses: zod.string().describe("Suspect-controlled addresses, comma-separated") }
	...
	server.registerPrompt("aml-trace-deposit-sources", {
		...
		argsSchema: { deposit_addresses: zod.string().describe("Suspected deposit/cashout addresses, comma-separated") }
	...
	server.registerPrompt("graph-query", {
		...
		argsSchema: { query: zod.string().describe("Read-only GQL/Cypher query") }
