	...
	for (const edge of edges) {
		...
		if (edge.relation === "terminal_exchange") {
			...
			if (!seedAddresses.has(edge.src) && !victimAddresses.has(edge.src)) {
				...
				else mergeCandidate(candidates, makeCandidate(edge.src, "exchange_deposit_candidate", edgeEvidence(edge, "Address is the penultimate hop before an exchange endpoint."), edge.seed_role === "scammer" ? .8 : .68, "review_required"));
			}
			continue;
		}
...
//# sourceMappingURL=public-tools-BxgG_DC_.mjs.map