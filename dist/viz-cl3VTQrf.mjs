...
import { n as truncateGraph } from "./data-extractor-B6h4PH2b.mjs";
...
async function generateVisualization(opts) {
	...
	if (opts.dataFile) {
		...
		const { extractGraphFromJson } = await import("./data-extractor-B6h4PH2b.mjs").then((n) => n.t);
		rawData = extractGraphFromJson(parsed);
	} else if (opts.caseId) {
		const { extractGraphFromCase } = await import("./data-extractor-B6h4PH2b.mjs").then((n) => n.t);
...
//# sourceMappingURL=viz-cl3VTQrf.mjs.map