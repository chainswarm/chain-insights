...
import { l as prepareWalletForPaidCalls } from "./tools-DwGCDBYx.mjs";
...
async function createConfiguredGraphPaidOrFreeFetch() {
	const { isWalletConfigured, decryptKey } = await import("./wallet-C4WnJpkA.mjs").then((n) => n.s);
...
//# sourceMappingURL=client-BP01tPOG.mjs.map