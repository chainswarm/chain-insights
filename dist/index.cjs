...
const require_topup_server = require("./topup-server-BGSx99wW.cjs");
...
exports.generateTopupPage = require_topup_server.generateTopupPage;
...
exports.stopTopupServer = require_topup_server.stopTopupServer;
