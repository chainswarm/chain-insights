...
function resolveNpmUpdateInvocation(packageName = PACKAGE_INFO.name, env = process.env) {
...
function runPackageUpdate(packageName = PACKAGE_INFO.name) {
...
//#endregion
export { checkForUpdate, maybePromptForUpdate, runPackageUpdate };

//# sourceMappingURL=update-CJUfGCxs.mjs.map