...
function valueFactor(value) {
	...
	return Math.log10(1 + Math.min(value, SCAM_TOPOLOGY_VALUE_SATURATION)) / Math.log10(1 + SCAM_TOPOLOGY_VALUE_SATURATION);
}
/**
...
//# sourceMappingURL=public-tools-BKNH0BGv.mjs.map