...
const require_active = require("./active-XWv72R1X.cjs");
...
function workspaceOutputPaths(workspaceRoot = requireWorkspaceRoot()) {
	...
	return {
		...
		artifactsRoot: node_path.default.join(root, "artifacts"),
		entitiesRoot: node_path.default.join(root, "entities"),
		sessionsRoot: node_path.default.join(root, "sessions"),
		publishedRoot: node_path.default.join(root, "published"),
